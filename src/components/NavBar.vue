...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="/" style="font-family: 'Brush Script MT', cursive;">HUST OJ</a>
            <router-link class="navbar-brand" :to="{name : 'home'}"></router-link>
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <!-- <router-link :class="route_name == 'pk_index' ? 'nav-link active' : 'nav-link'" :to="{name:'pk_index'}">对战</router-link> -->
                        <router-link class="nav-link" active-class="active" :to="{ name: 'problem_index' }"> 题目列表</router-link>
                    </li>
                    <li class="nav-item">
